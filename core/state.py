...
class AppState:
    def __init__(self):
        ...
        # Позиции, чей фактический риск превысил жёсткий потолок 3%.
        # symbol -> процент. Обнаружение было, но жило только в логе, да и
        # то одной строкой за жизнь позиции: при отсутствии алертинга это
        # ноль внимания. Инвариант из CLAUDE.md обязан быть виден на экране.
        self.over_risk: Dict[str, float] = {}
