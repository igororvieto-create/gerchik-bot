...
class Config:
    ...
    # Market orders fill immediately; limit orders use exact entry price (rarely fills in fast markets)
    USE_LIMIT_ORDERS:         bool  = os.getenv("USE_LIMIT_ORDERS", "false").strip().lower() == "true"
